...
function App() {
	...
	React.useEffect(() => {
		async function fetchData(){
			setIsLoading(true);
			const cartResponse = await axios.get('https://62bc12c6eff39ad5ee1bc7e3.mockapi.io/cart');
			const favoritesResponse = await axios.get('https://62bc12c6eff39ad5ee1bc7e3.mockapi.io/favorites');
			const itemsResponse = await axios.get('https://62bc12c6eff39ad5ee1bc7e3.mockapi.io/items');
	...
	const onAddToCart = (obj) => {
			if (cartItems.find ((item) => Number(item.id) === Number(obj.id))) {
				axios.delete(`https://62bc12c6eff39ad5ee1bc7e3.mockapi.io/cart/${obj.id}`);
